...
type _schemaOutputIsValidContract = Extends<z.infer<typeof styleSnapExportSchema>, StyleSnapExport>;
// eslint-disable-next-line @typescript-eslint/no-unused-vars
type _contractIsAcceptedBySchema = Extends<StyleSnapExport, z.infer<typeof styleSnapExportSchema>>;
// eslint-disable-next-line @typescript-eslint/no-unused-vars
type _tokenUnionMatches = Extends<z.infer<typeof styleSnapTokenSchema>, StyleSnapToken>;
